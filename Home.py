...
def analisar_planilha(nome_arquivo):
...
# Cartão: Aprovadores (Ajustei o href pra apontar pro nome do arquivo provável)
html_aprovadores = f"""
    ...
    <div style="{estilo_caixa}">
        <div style="display: flex; align-items: center;">
            ...
            <div>
                ...
                <p style="margin: 0; color: #888; font-size: 0.9em;">Gestão e Validação de Regras de Aprovação (Protheus & Fluig)</p>
            </div>
        </div>
...
# Cartão: Roncador (Ajustei o href pra apontar pro nome do arquivo provável)
html_roncador = f"""
